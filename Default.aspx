<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TnTPZK._Default" %>
	...
	<div id="slider" class="flexslider">
        ...
        <ul class="slides">
            <li>
				...
				<div class="caption">
					<h2><span>TnT Performance</span></h2> 
					<h2><span></span></h2>
					<p>Check out our new builds...</p>
            ...
            <li>
				...
				<div class="caption">
					<h3><span>Featuring:</span></h3> 
					<h2><span>PZK Designs</span></h2>
					<p>Welcome to the body side of the TnT team...</p>
					<button class="btn">Read More</button>                 
	            </div>
